...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 font-sans">
      ...
      <section id="ai-feedback" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Get Expert Feedback on Your Writing</h2>
              <p className="text-gray-600 mb-6">
                Our advanced AI analyzes your writing tasks and provides detailed feedback just like a human examiner would. Improve your writing skills with personalized suggestions.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h4 className="font-medium">Grammar & Vocabulary Analysis</h4>
                    <p className="text-gray-600 text-sm">Identify errors and get suggestions for more advanced vocabulary.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <div className="ml-3">
                    <h4 className="font-medium">Structure & Coherence Feedback</h4>
                    <p className="text-gray-600 text-sm">Learn how to better organize your ideas and create a more coherent essay.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <div className="ml-3">
                    <h4 className="font-medium">Task Achievement Guidance</h4>
                    <p className="text-gray-600 text-sm">Understand how well you've addressed the task and how to improve.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="md:w-1/2">
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <div className="text-sm text-gray-500">Task 2 Essay</div>
                    <div className="font-medium">Some people believe that unpaid community service should be a compulsory part of high school education. To what extent do you agree or disagree?</div>
                  </div>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg mb-6 text-sm">
                  <p className="mb-3">In today's competitive world, many argue that community service should be mandatory for high school students. I strongly agree with this view as it provides numerous benefits to both students and society.</p>
                  <p className="mb-3">Firstly, community service teaches young people important life skills. When teenagers volunteer at homeless shelters or environmental clean-ups, they develop empathy, teamwork, and leadership abilities. These soft skills are difficult to learn in traditional classroom settings but are crucial for future success.</p>
                  <p>Furthermore, mandatory community service would benefit society as a whole. Schools could partner with local organizations to address community needs while giving students practical experience...</p>
                </div>
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex items-center mb-3">
                    ...
                    <div className="ml-2 font-medium">AI Feedback</div>
                  </div>
                  <div className="space-y-3 text-sm">
                    <div>
                      <div className="font-medium text-green-600">Strengths:</div>
                      <ul className="list-disc pl-5 text-gray-700">
                        <li>Clear position stated in introduction</li>
                        <li>Good paragraph structure with topic sentences</li>
                        <li>Relevant examples provided</li>
                      </ul>
                    </div>
                    <div>
                      <div className="font-medium text-amber-600">Areas for Improvement:</div>
                      <ul className="list-disc pl-5 text-gray-700">
                        <li>Consider including counterarguments for a more balanced essay</li>
                        <li>Use more complex sentence structures to demonstrate range</li>
                        <li>Expand your academic vocabulary (suggestions provided)</li>
                      </ul>
                    </div>
                    <div className="pt-2">
                      <div className="font-medium">Estimated Band Score: <span className="text-blue-600">6.5</span></div>
                      <div className="text-xs text-gray-500">You're on the right track! With some improvements to vocabulary and sentence structure, you could reach band 7.</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 IELTS Ace . All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
