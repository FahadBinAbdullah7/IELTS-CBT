...
import { Student, useAuth } from "../contexts/AuthContext";
...
const StudentResults: React.FC = () => {
  ...
  const loadStudentResults = async () => {
    try {
      ...
      console.log((student as Student).email);
      const { data: studentData, error: studentDataError } = await supabase
        .from("students")
        .select("*")
        .eq("email", (student as Student).email)
        .single();

      if (studentDataError) throw studentDataError;

      const attempts = await DatabaseService.getExamAttemptsByStudent(
        studentData.id
      );
      ...
      if (completedAttempts.length > 0) {
        ...
        const latest = completedAttempts.sort(
          (a, b) =>
  ...
  const viewDetailedResults = () => {
    ...
    const answers =
      typeof latestAttempt.answers === "string"
        ? JSON.parse(latestAttempt.answers)
        : latestAttempt.answers || {};

    const writingFeedback =
      typeof latestAttempt.writing_feedback === "string"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link to="/student/results" className="text-blue-600 font-medium">
                Results
              </Link>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Track your IELTS performance and progress
            </p>
          </div>
          ...
          {latestAttempt ? (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-center">
                  ...
                  <div
                    className={`text-5xl font-bold px-4 py-2 rounded-full ${getBandColor(
                ...
                {Object.entries(
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`text-3xl font-bold px-3 py-1 rounded-full ${getBandColor(
                          score as number
                        )}`}
                      >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                You haven't completed any exams yet. Take your first IELTS
                practice test to see your results here.
              </p>
              <Link
                to="/student/dashboard"
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {allAttempts.length > 0
                      ? (
                          allAttempts.reduce(
                            (sum, attempt) => sum + attempt.overall_band,
                            0
                          ) / allAttempts.length
                        ).toFixed(1)
                      : "0.0"}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {allAttempts.length > 0
                      ? Math.max(
                          ...allAttempts.map((a) => a.overall_band)
                        ).toFixed(1)
                      : "0.0"}
                  </p>
                </div>
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
      ...
      <div className="text-right flex items-center space-x-3">
        <div>
          <div
            className={`text-lg font-semibold px-3 py-1 rounded-full ${getBandColor(
