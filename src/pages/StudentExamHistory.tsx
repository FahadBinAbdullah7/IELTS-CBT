          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                <span
                  className={`px-3 py-1 rounded-full text-sm font-semibold ${getBandColor(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link to="/student/exams" className="text-blue-600 font-medium">
                Exam History
              </Link>
              <Link
                to="/student/results"
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Review your past exam attempts and performance
            </p>
          </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {examAttempts.length > 0
                      ? Math.max(
                          ...examAttempts.map((a) => a.overall_band)
                        ).toFixed(1)
                      : "0.0"}
                  </p>
                </div>
            ...
            {examAttempts.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Start your IELTS preparation by taking a practice test.
                </p>
                <Link
                  to="/student/dashboard"
